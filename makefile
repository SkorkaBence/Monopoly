...
FILES   = main.cpp Storage/Vector.cpp Storage/VectorException.cpp Monopoly/MonopolyException.cpp Monopoly/Game.cpp Monopoly/Printer/Printer.cpp Monopoly/Randomizer/OneDice.cpp Monopoly/Fields/Property.cpp Monopoly/Fields/Service.cpp Monopoly/Fields/Luck.cpp Monopoly/Player/Player.cpp Monopoly/Player/AI/AI.cpp
TARGET  = run
